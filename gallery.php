    ...
    <div class="page-wrapper">
      ...
      ?><!-- /.stricky-header -->
       ...
       <section class="page-header">
            <div class="page-header__bg" style="background-image: url(assets/images/resources/aboutbg.jpg);"></div>
            <!-- /.page-header__bg -->
            <div class="container">
                <h2>Gallery</h2>
                <ul class="thm-breadcrumb list-unstyled">
                    ...
                    <li><a href="become-volunteer.html">Certificate</a></li>
                       ...
                       <!--Gallery page Single-->
                        <div class="gallery-page__single">
                            <div class="gallery-page__img-box">
                                <img src="assets/images/resources/workers.jpg" alt="">
